...
JOB_ROLE_REQUIREMENTS: Dict[str, Dict] = {
    "remote_customer_support_officer": {
        "required": _vec(digital_literacy=0.7, language_proficiency=0.7,
                         written_communication=0.8, customer_service=0.8,
                         ticket_handling=0.7, workplace_behavior=0.6,
                         time_management=0.6, assessment_performance=0.6),
        "importance": _vec(written_communication=1.0, customer_service=1.0,
                           ticket_handling=0.9, language_proficiency=0.8,
                           digital_literacy=0.6),
        "min_readiness": 0.62,
        "work_modes": ["remote", "hybrid"],
    },
    "data_entry_assistant": {
        "required": _vec(digital_literacy=0.6, data_entry=0.85, spreadsheet_skills=0.8,
                         task_accuracy=0.85, attention_to_detail=0.8,
                         time_management=0.6, assessment_performance=0.6),
        "importance": _vec(data_entry=1.0, task_accuracy=1.0, attention_to_detail=0.9,
                           spreadsheet_skills=0.8, digital_literacy=0.5),
        "min_readiness": 0.60,
        "work_modes": ["remote", "hybrid", "onsite"],
    },
    "digital_accessibility_tester": {
        "required": _vec(digital_literacy=0.7, accessibility_testing=0.85,
                         screen_reader_use=0.8, keyboard_navigation=0.8,
                         defect_reporting=0.75, attention_to_detail=0.8,
                         assistive_tech_readiness=0.7, assessment_performance=0.6),
        "importance": _vec(accessibility_testing=1.0, screen_reader_use=0.9,
                           keyboard_navigation=0.9, defect_reporting=0.8,
                           attention_to_detail=0.7),
        "min_readiness": 0.64,
        "work_modes": ["remote", "hybrid"],
    },
    "administrative_assistant": {
        "required": _vec(digital_literacy=0.7, written_communication=0.7,
                         spreadsheet_skills=0.6, time_management=0.7,
                         task_accuracy=0.7, workplace_behavior=0.6,
                         assessment_performance=0.6),
        "importance": _vec(time_management=1.0, written_communication=0.9,
                           task_accuracy=0.8, digital_literacy=0.7),
        "min_readiness": 0.60,
        "work_modes": ["onsite", "hybrid"],
    },
    "e_commerce_support_worker": {
        "required": _vec(digital_literacy=0.7, customer_service=0.7,
                         written_communication=0.7, ticket_handling=0.6,
                         task_accuracy=0.7, assessment_performance=0.6),
        "importance": _vec(customer_service=1.0, written_communication=0.8,
                           ticket_handling=0.7, digital_literacy=0.6),
        "min_readiness": 0.60,
        "work_modes": ["remote", "hybrid"],
    },
    "content_moderation_assistant": {
        "required": _vec(digital_literacy=0.7, attention_to_detail=0.8,
                         problem_solving=0.6, workplace_behavior=0.7,
                         task_accuracy=0.7, assessment_performance=0.6),
        "importance": _vec(attention_to_detail=1.0, problem_solving=0.8,
                           workplace_behavior=0.8, digital_literacy=0.6),
        "min_readiness": 0.61,
        "work_modes": ["remote"],
    },
    "junior_software_testing_assistant": {
        "required": _vec(digital_literacy=0.7, test_case_execution=0.8,
                         defect_reporting=0.75, attention_to_detail=0.8,
                         problem_solving=0.65, workplace_behavior=0.6,
                         assessment_performance=0.6),
        "importance": _vec(test_case_execution=1.0, defect_reporting=0.9,
                           attention_to_detail=0.8, problem_solving=0.7,
                           digital_literacy=0.6),
        "min_readiness": 0.63,
        "work_modes": ["remote", "hybrid"],
    },
...
LEARNING_RESOURCES: List[Dict] = [
    {"resource_id": "R01", "title": "Spreadsheet Fundamentals (adaptive)",
     ...
     "language": "multi"},
    {"resource_id": "R02", "title": "Accurate Data Entry & Error Checking",
     ...
     "language": "multi"},
    {"resource_id": "R03", "title": "Written Customer Communication",
     ...
     "language": "multi"},
    {"resource_id": "R04", "title": "Complaint Handling Role-Play (captioned)",
     ...
     "language": "multi"},
    {"resource_id": "R05", "title": "Screen-Reader Testing Procedures",
     ...
     "language": "multi"},
    {"resource_id": "R06", "title": "Keyboard-Only Navigation & Defect Reporting",
     ...
     "language": "multi"},
    {"resource_id": "R07", "title": "Structured Test-Case Execution",
     ...
     "language": "multi"},
    {"resource_id": "R08", "title": "Defect Classification & Reporting",
     ...
     "language": "multi"},
    {"resource_id": "R09", "title": "Workplace Behavior & Communication Practice",
     "competencies": ["workplace_behavior", "verbal_communication", "time_management"],
     "roles": ["junior_software_testing_assistant", "content_moderation_assistant",
               "administrative_assistant"],
     "accessibility_modes": {"visual_schedule", "predictable_structure", "scenario_based"},
     "language": "multi"},
    {"resource_id": "R10", "title": "Digital Literacy Essentials",
     ...
     "language": "multi"},
    {"resource_id": "R11", "title": "Attention & Detail Drills (content moderation)",
     ...
     "language": "multi"},
    {"resource_id": "R12", "title": "Assistive Technology Readiness",
...
DISABILITY_ADAPTATIONS: Dict[str, List[str]] = {
    "cognitive": [
        "short micro-lessons", "simplified text", "repeated examples",
        "visual prompts", "step-by-step instructions", "low-distraction interfaces",
        "frequent formative feedback",
    ],
    "hearing": [
        "captioned video material", "text-based communication exercises",
        "transcript-supported role-play", "written customer-service templates",
    ],
    "vision": [
        "screen-reader compatible content", "keyboard-only exercises",
        "audio instructions", "accessible assessment interfaces",
    ],
    "mobility": [
        "alternative input methods", "adjustable task duration",
        "voice-based interaction", "reduced fine-motor interaction requirements",
    ],
    "communication": [
        "predictable task structures", "explicit instructions", "visual schedules",
        "scenario-based workplace communication practice", "low-ambiguity assessment tasks",
    ],
}
...
DISABILITY_ACCESSIBILITY_MODES: Dict[str, set] = {
    "cognitive": {"simplified_text", "step_by_step", "repeated_practice",
                  "visual_prompts", "low_distraction"},
    ...
    "communication": {"structured_tasks", "visual_schedule", "predictable_structure",
                      "low_ambiguity", "scenario_based"},
}
